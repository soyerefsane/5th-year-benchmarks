...
// file://home/efsane/Documents/issue-332/src/hello2.lf
#define LOG_LEVEL 2
#define TARGET_FILES_DIRECTORY "/home/efsane/Documents/issue-332/src-gen/hello2"
...
void _lf_create_environments() {
    environment_init(&envs[hello2_main],"hello2",hello2_main,_lf_number_of_workers,0,1,0,0,0,0,0,NULL);
}
...
void _lf_initialize_trigger_objects() {
    ...
    _hello2_main_main_self_t* hello2_main_self[1];
    SUPPRESS_UNUSED_WARNING(hello2_main_self);
    // ***** Start initializing hello2 of class hello2
    hello2_main_self[0] = new__hello2_main();
    hello2_main_self[0]->base.environment = &envs[hello2_main];
    bank_index = 0; SUPPRESS_UNUSED_WARNING(bank_index);
    envs[hello2_main].startup_reactions[startup_reaction_count[hello2_main]++] = &hello2_main_self[0]->_lf__reaction_0;
    SUPPRESS_UNUSED_WARNING(_lf_watchdog_count);
    
    hello2_main_self[0]->_lf__reaction_0.deadline = NEVER;
    //***** End initializing hello2
    // **** Start deferred initialize for hello2
    {
    
        // Total number of outputs (single ports and multiport channels)
        // produced by reaction_1 of hello2.
        hello2_main_self[0]->_lf__reaction_0.num_outputs = 0;
        {
            int count = 0; SUPPRESS_UNUSED_WARNING(count);
        }
        
        // ** End initialization for reaction 0 of hello2
    
    }
    // **** End of deferred initialize for hello2
    // **** Start non-nested deferred initialize for hello2
    {
    
    
    
    }
    // **** End of non-nested deferred initialize for hello2
    // Connect inputs and outputs for reactor hello2.

    
    // Set reaction priorities for ReactorInstance hello2
    {
        hello2_main_self[0]->_lf__reaction_0.chain_id = 1;
        // index is the OR of level 0 and 
        // deadline 9223372036854775807 shifted left 16 bits.
        hello2_main_self[0]->_lf__reaction_0.index = 0xffffffffffff0000LL;
    }
