...
// file://home/efsane/Documents/issue-332/src/gpio_cmake.lf
#define LOG_LEVEL 2
...
void lf_create_environments() {
    environment_init(&envs[gpio_cmake_main],"gpio_cmake",gpio_cmake_main,_lf_number_of_workers,0,1,0,0,0,0,0,0,NULL);
}
...
void _lf_initialize_trigger_objects() {
    ...
    _gpio_cmake_main_main_self_t* gpio_cmake_main_self[1];
    SUPPRESS_UNUSED_WARNING(gpio_cmake_main_self);
    // ***** Start initializing gpio_cmake of class gpio_cmake
    gpio_cmake_main_self[0] = new__gpio_cmake_main();
    gpio_cmake_main_self[0]->base.environment = &envs[gpio_cmake_main];
    bank_index = 0; SUPPRESS_UNUSED_WARNING(bank_index);
    envs[gpio_cmake_main].startup_reactions[startup_reaction_count[gpio_cmake_main]++] = &gpio_cmake_main_self[0]->_lf__reaction_0;
    
    gpio_cmake_main_self[0]->_lf__reaction_0.deadline = NEVER;
    //***** End initializing gpio_cmake
    // **** Start deferred initialize for gpio_cmake
    {
    
        // Total number of outputs (single ports and multiport channels)
        // produced by reaction_1 of gpio_cmake.
        gpio_cmake_main_self[0]->_lf__reaction_0.num_outputs = 0;
        {
            int count = 0; SUPPRESS_UNUSED_WARNING(count);
        }
        
        // ** End initialization for reaction 0 of gpio_cmake
    
    }
    // **** End of deferred initialize for gpio_cmake
    // **** Start non-nested deferred initialize for gpio_cmake
    {
    
    
    
    }
    // **** End of non-nested deferred initialize for gpio_cmake
    // Connect inputs and outputs for reactor gpio_cmake.

    
    // Set reaction priorities for ReactorInstance gpio_cmake
    {
        gpio_cmake_main_self[0]->_lf__reaction_0.chain_id = 1;
        // index is the OR of level 0 and 
        // deadline 9223372036854775807 shifted left 16 bits.
        gpio_cmake_main_self[0]->_lf__reaction_0.index = 0xffffffffffff0000LL;
    }
    ...
    lf_sched_init(
        &envs[gpio_cmake_main],
        envs[gpio_cmake_main].num_workers,
        &sched_params
    );
